...
INSERT INTO `movies` (`movie_id`, `title`, `description`, `release_date`, `cover_image`, `type`, `region`, `creators`, `vip`, `price`, `stars`, `week_ranking`, `month_ranking`, `total_ranking`, `reviews_ranking`) VALUES 
(
    100001, 
    '肖申克的救赎', 
...
　　本片获孟买电影博览奖最佳影片、最佳导演、最佳配角（波曼·伊拉尼）、最佳剧本等六项大奖，并获国际印度电影协会最佳影片、最佳导演、最佳剧情、最佳摄影等十六项大奖。',
	...
	'印度',
	'导演: 拉吉库马尔·希拉尼
编剧: 维德胡·维诺德·乔普拉 / 拉吉库马尔·希拉尼
主演: 阿米尔·汗 / 卡琳娜·卡普尔 / 马达范',
	'1',
	'0',
	'4',
	18,
